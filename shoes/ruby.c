...
static void shoes_pattern_gradient(shoes_pattern *pattern, VALUE r1, VALUE r2, VALUE attr) {
...
static void shoes_color_free(shoes_color *color) {
...
static void shoes_timer_free(shoes_timer *timer) {
