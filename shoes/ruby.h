...
extern VALUE cShoes, cApp, cCanvas, cFlow, cStack, cMask, cNative, cPath, cImage, cAnim, cPattern, cBorder, cBackground, cPara, cLinkText, cTextClass, cStrong, cButton, cEditLine, cEditBox, cListBox, cProgress, cColor, cColors, cLink;
