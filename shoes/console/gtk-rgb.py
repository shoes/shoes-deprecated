...
def print_all():
    ...
    """
    sys.stdout.write ("// generated from gtk-rgb.py\n")
    sys.stdout.write ("char *colorstrings[256] = {\n")
    for short, rgb in CLUT:
        #sys.stderr.write('\033[48;5;%sm%s:%s' % (short, short, rgb))
        #sys.stderr.write("\033[0m  ")
        #sys.stderr.write('\033[38;5;%sm%s:%s' % (short, short, rgb))
        #sys.stderr.write("\033[0m\n")
