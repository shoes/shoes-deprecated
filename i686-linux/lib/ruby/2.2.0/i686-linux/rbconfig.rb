...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.2.0/i686-linux")
  ...
  CONFIG["configure_args"] = " '--with-baseruby=/usr/local/bin/ruby' '--enable-shared' '--enable-load-relative' '--disable-install-doc' '--without-tk' '--without-tcllib' '--without-tcltk' '--prefix=/usr/local' 'LDFLAGS=-L/usr/local/lib' 'CPPFLAGS=-I/usr/local/include'"
