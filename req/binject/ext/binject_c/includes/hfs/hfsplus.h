...
#define HFS_S_ISUID 0004000     /* set user id on execution */
#define HFS_S_ISGID 0002000     /* set group id on execution */
#define HFS_S_ISTXT 0001000     /* sticky bit */

#define HFS_S_IRWXU 0000700     /* RWX mask for owner */
#define HFS_S_IRUSR 0000400     /* R for owner */
#define HFS_S_IWUSR 0000200     /* W for owner */
#define HFS_S_IXUSR 0000100     /* X for owner */

#define HFS_S_IRWXG 0000070     /* RWX mask for group */
#define HFS_S_IRGRP 0000040     /* R for group */
#define HFS_S_IWGRP 0000020     /* W for group */
#define HFS_S_IXGRP 0000010     /* X for group */

#define HFS_S_IRWXO 0000007     /* RWX mask for other */
#define HFS_S_IROTH 0000004     /* R for other */
#define HFS_S_IWOTH 0000002     /* W for other */
#define HFS_S_IXOTH 0000001     /* X for other */

#define HFS_S_IFMT   0170000    /* type of file mask */
#define HFS_S_IFIFO  0010000    /* named pipe (fifo) */
#define HFS_S_IFCHR  0020000    /* character special */
#define HFS_S_IFDIR  0040000    /* directory */
#define HFS_S_IFBLK  0060000    /* block special */
#define HFS_S_IFREG  0100000    /* regular */
#define HFS_S_IFLNK  0120000    /* symbolic link */
#define HFS_S_IFSOCK 0140000    /* socket */
#define HFS_S_IFWHT  0160000    /* whiteout */
