...
LINUX_CFLAGS = %[-g -Wall -I#{BREWLOC}/include -I /usr/include #{CAIRO_CFLAGS} #{PANGO_CFLAGS} -I#{RbConfig::CONFIG['archdir']}]
...
# LINUX_CFLAGS << ' -mmacosx-version-min=10.6'
