...
# nothing is going to change for 10.6 deps - don't bother with pkg-config
...
RUBY_CFLAGS   = "-I#{BREWLOC}/include/ruby-2.1.0/x86_64-darwin10.0 -I#{BREWLOC}/include/ruby-2.1.0 "
...
LINUX_CFLAGS << " -DOLD_OSX -DSHOES_QUARTZ -Wall -fpascal-strings -x objective-c -fobjc-exceptions"
