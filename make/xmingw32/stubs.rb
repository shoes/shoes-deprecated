...
# it requires g++ - might that cause winject to be confused? 
...
task :stubs  do
  ...
  Dir.chdir("platform/msw") do
    sh "#{CC} #{LINUX_CFLAGS} -I../../ -c stub.c"
    sh "i686-w64-mingw32-windres  -o stub32.o -i stub32.rc"
    sh "#{CC} -o shoes-stub.exe  stub.o  stub32.o ../../shoes/http/winhttp.o -lwinhttp -lcomctl32 -mwindows "
